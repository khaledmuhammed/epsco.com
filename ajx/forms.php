...
if ($action == 'submit') {
	...
	if ($id == 19) {
		...
		$title1 = model::secure($_POST['title1']);
		$title3 = model::secure($_POST['title3']);
		$title4 = model::secure($_POST['title4']);
		$title5 = model::secure($_POST['title5']);									
		$title6 = model::secure($_POST['title6']);
		$title7 = model::secure($_POST['title7']);
		$title2 = model::secure($_POST['title2']);
		$title9 = model::secure($_POST['title9']);
		$title10 = model::secure($_POST['title10']);									
		$title11 = model::secure($_POST['title11']);
		$title12 = model::secure($_POST['title12']);
		$title13 = model::secure($_POST['title13']);
		$title14 = model::secure($_POST['title14']);
		...
		$value = array($img,$title,$title1,$title3,$title4,$title5,$title6,$title7,$title2,$title9,$title10,$title11,$title12,$title13,$title14);
		$obj = json_encode($value,JSON_UNESCAPED_UNICODE);
		$x = array();
		$x['data'] = $obj;
		$update = data::updateArray($x,'id',$id);
