			...
			<form role="form" onsubmit="submitForm(this,'forms.php')" prevent-default>
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="title" name="title" value="<?= $data[1];?>" placeholder="title..." required>
					</div>

					<div class="form-group">
						<label for="title1">Title Main 1</label>
						<input type="text" class="form-control" id="title1" name="title1" value="<?= $data[2];?>" placeholder="title 1..." required>
					</div>

					<div class="form-group">
						<label for="title3">Title Main of List</label>
						<input type="text" class="form-control" id="title3" name="title3" value="<?= $data[3];?>" placeholder="title 3..." required>
					</div>

					<div class="form-group">
						<label for="title4">Title List 1</label>
						<input type="text" class="form-control" id="title4" name="title4" value="<?= $data[4];?>" placeholder="title 4..." required>
					</div>

					<div class="form-group">
						<label for="title5">Title List 2</label>
						<input type="text" class="form-control" id="title5" name="title5" value="<?= $data[5];?>" placeholder="title 5..." required>
					</div>

					<div class="form-group">
						<label for="title6">Title List 3</label>
						<input type="text" class="form-control" id="title6" name="title6" value="<?= $data[6];?>" placeholder="title 6..." required>
					</div>

					<div class="form-group">
						<label for="title7">Title List 4</label>
						<input type="text" class="form-control" id="title7" name="title7" value="<?= $data[7];?>" placeholder="title 7..." required>
					</div>

					<div class="form-group">
						<label for="title2">Title Main 2</label>
						<input type="text" class="form-control" id="title2" name="title2" value="<?= $data[8];?>" placeholder="title 2..." required>
					</div>

					<div class="form-group">
						<label for="title9">Title Main 3</label>
						<input type="text" class="form-control" id="title9" name="title9" value="<?= $data[9];?>" placeholder="title 9..." required>
					</div>

					<div class="form-group">
						<label for="title10">Title Main 4</label>
						<input type="text" class="form-control" id="title10" name="title10" value="<?= $data[10];?>" placeholder="title 10..." required>
					</div>
					<div class="form-group">
						<label for="title11">Title Main 5</label>
						<input type="text" class="form-control" id="title11" name="title11" value="<?= $data[11];?>" placeholder="title11..." required>
					</div>

					<div class="form-group">
						<label for="title12">Title Main 6</label>
						<input type="text" class="form-control" id="title12" name="title12" value="<?= $data[12];?>" placeholder="title12..." required>
					</div>

					<div class="form-group">
						<label for="title13">Title Main 7</label>
						<input type="text" class="form-control" id="title13" name="title13" value="<?= $data[13];?>" placeholder="title 13..." required>
					</div>

					<div class="form-group">
						<label for="title14">Title Main 8</label>
						<input type="text" class="form-control" id="title14" name="title14" value="<?= $data[14];?>" placeholder="title 14..." required>
					</div>
